...
path_matlab=args[1]#"/Applications/MATLAB/MATLAB_Runtime/v99" #Where you matlab runtime is installed
path=args[2]#getwd()#Path to your working directory
...
if(BGL=="on"){
  ...
  items=c(paste0(path,"run_BGL.sh"),path_matlab,path)
